...
const effect_104010448_continuous: CardEffect = {
  id: '104010448_continuous',
  type: 'CONTINUOUS',
...
const effect_104010448_trigger: CardEffect = {
  id: '104010448_trigger',
  type: 'TRIGGER',
  triggerLocation: ['UNIT'],
...
const card: Card = {
  ...
  canResetCount: 0,
  effects: [
    effect_104010448_continuous,
    effect_104010448_trigger
  ],
  rarity: 'R',
  availableRarities: ['R'],
  cardPackage: 'BT04',
