    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* Header */}
            <div className="sticky top-0 z-10 flex items-center justify-between px-8 py-6 bg-[#1a1a1a] border-b border-[#f27d26]/20">
              <div className="flex items-center gap-3">
                <Book className="w-6 h-6 text-[#f27d26]" />
            ...
            {/* Content */}
            <div className="p-8 space-y-12 text-gray-300 font-sans leading-relaxed overflow-y-auto max-h-[80vh]">
              
              {/* Section 1: Deck & Winning */}
              <section className="space-y-4">
                <h3 className="text-xl font-bold text-[#f27d26] border-l-4 border-[#f27d26] pl-4 uppercase">
                  一、核心规则
                </h3>
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-4">
                  <p className="text-sm">使用卡牌需满足两个条件：</p>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <h4 className="text-white font-semibold">1. 颜色需求</h4>
                      <p className="text-sm opacity-80">统计战场单位及侵蚀区正面卡的颜色，需满足卡牌左上角标记。</p>
                    </div>
                    <div className="space-y-2">
                      <h4 className="text-white font-semibold">2. 支付 ACCESS 值</h4>
              ...
              <section className="p-8 bg-gradient-to-br from-[#f27d26]/20 to-transparent rounded-2xl border border-[#f27d26]/30">
              ...
              <section className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={i} className="p-4 bg-white/5 rounded-lg border border-white/5 hover:border-[#f27d26]/30 transition-all">
                      <div className="text-[#f27d26] font-bold text-xs mb-1 uppercase">{phase.title}</div>
