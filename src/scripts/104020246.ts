...
const continuous_104020246_power_fixed: CardEffect = {
  id: '104020246_power_fixed',
  type: 'CONTINUOUS',
...
const trigger_104020246_guard: CardEffect = {
  id: '104020246_guard_trigger',
  type: 'TRIGGER',
  triggerLocation: ['UNIT'],
...
const card: Card = {
  ...
  canResetCount: 0,
  effects: [
    continuous_104020246_power_fixed,
    trigger_104020246_guard
  ],
  rarity: 'R',
  availableRarities: ['R'],
  cardPackage: 'ST03',
